...
describe('quizReducer', () => {
  ...
  it('should handle SET_QUESTIONS', () => {
    const questions: Question[] = [{ category: 'test', question: 'test', correct_answer: 'true', incorrect_answers: ['false'], difficulty: 'easy', type: 'boolean' }];
  ...
  it('should handle RESET_QUIZ', () => {
    ...
    const newState = quizReducer(modifiedState, action);
